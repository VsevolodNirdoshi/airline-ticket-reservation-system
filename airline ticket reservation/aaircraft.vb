...
Public Class aaircraft
    ...
    Private Sub aaircraft_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Me.AircraftTableAdapter1.Fill(Me.AirlineReservationSystemDataSet.Aircraft)
        AircraftTypeId.Focus()
    ...
    Private Sub AirlineName1_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles AirlineName1.SelectedIndexChanged
        ...
        Dim con As New SqlConnection("Data Source=(LocalDB)\v11.0;AttachDbFilename=C:\Users\MY\Documents\Visual Studio 2012\Projects\airline ticket reservation\airline ticket reservation\AirlineReservationSystem.mdf;Integrated Security=True;Connect Timeout=30")
        con.Open()
    ...
    Private Sub Delete_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Delete.Click
       ...
       New SqlParameter("@find", System.Data.SqlDbType.NChar, 10, "AirCraftTypeId"))
        ...
        Else
            ...
            Dim ch As String = "Data Source=(LocalDB)\v11.0;AttachDbFilename=C:\Users\MY\Documents\Visual Studio 2012\Projects\airline ticket reservation\airline ticket reservation\AirlineReservationSystem.mdf;Integrated Security=True;Connect Timeout=30"
            con = New SqlConnection(cp)

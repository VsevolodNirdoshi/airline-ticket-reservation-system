...
Public Class aScheduleFlight  
        ...
        cmd.Connection = con
        cmd.Parameters.Add(New SqlParameter("@find", System.Data.SqlDbType.NChar, 10, "scheduleID"))
    ...
    Private Sub Delete_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Delete.Click
        ...
        cmd.Parameters.Add(New SqlParameter("@delete1", System.Data.SqlDbType.NChar, 10, "ScheduleID"))
    ...
    Private Sub Edit_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Edit.Click
        ...
        cmd.Parameters("@UPDATE1").Value = ScheduleID.Text

        cmd.Parameters("@UPDATE2").Value = FlightNo.Text

        cmd.Parameters("@UPDATE3").Value = FlightDate.Text
        cmd.Parameters("@UPDATE4").Value = FirstClassSeatAvailable.Text
        cmd.Parameters("@UPDATE5").Value = BusinessClassSeatAvailable.Text
        cmd.Parameters("@UPDATE6").Value = EconomyClassSeatAvailable.Text

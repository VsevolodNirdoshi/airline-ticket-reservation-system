    ...
    Private Sub Delete_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Delete.Click
       ...
       New SqlParameter("@find", System.Data.SqlDbType.NChar, 10, "SectorID"))
        ...
        Else
            ...
            Dim cf As String = "Data Source=(LocalDB)\v11.0;AttachDbFilename=C:\Users\MY\Documents\Visual Studio 2012\Projects\airline ticket reservation\airline ticket reservation\AirlineReservationSystem.mdf;Integrated Security=True;Connect Timeout=30"
           ...
           New SqlParameter("@DELETE7", System.Data.SqlDbType.NChar, 10, "EconomyClassFare"))
            ...
            cmd.Parameters("@DELETE2").Value = Source.Text
            cmd.Parameters("@DELETE3").Value = Destination.Text

            cmd.Parameters("@DELETE4").Value = WeekDays.Text



            cmd.Parameters("@DELETE5").Value = FirstClassFare.Text
            cmd.Parameters("@DELETE6").Value = BusinessClassFare.Text
            cmd.Parameters("@DELETE7").Value = EconomyClassFare.Text
...
Or (Microsoft.VisualBasic.Asc(e.KeyChar) > 122) Then
    ...
    Private Sub Sector_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Me.SectorTableAdapter.Fill(Me.AirlineReservationSystemDataSet.Sector)

...
Private Sub Cancel_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Cancel.Click
    ...
    Else
            ...
            cmd.Parameters.Add(New SqlParameter("@INSERT1", System.Data.SqlDbType.NChar, 10, "PnrNo"))

            cmd.Parameters.Add(New SqlParameter("@INSERT2", System.Data.SqlDbType.NChar, 20, "Firstname"))

            cmd.Parameters.Add(New SqlParameter("@INSERT3", System.Data.SqlDbType.NChar, 20, "LastName"))

            cmd.Parameters.Add(New SqlParameter("@INSERT4", System.Data.SqlDbType.NChar, 10, "RefundAmount"))

            cmd.Parameters.Add(New SqlParameter("@INSERT5", System.Data.SqlDbType.NChar, 30, "date"))
            ...
            cmd.Parameters("@INSERT2").Value = Fname.Text
            cmd.Parameters("@INSERT3").Value = Lname.Text
            cmd.Parameters("@INSERT4").Value = AmtRefund.Text
            cmd.Parameters("@INSERT5").Value = DateTime.Now
            ...
            Dim cd As String = "Data Source=(LocalDB)\v11.0;AttachDbFilename=C:\Users\MY\Documents\Visual Studio 2012\Projects\airline ticket reservation\airline ticket reservation\AirlineReservationSystem.mdf;Integrated Security=True;Connect Timeout=30"
            ...
            cmd.Parameters.Add(New SqlParameter("@INSERT2", System.Data.SqlDbType.NChar, 30, "date"))

            cmd.Parameters.Add(New SqlParameter("@INSERT3", System.Data.SqlDbType.NChar, 10, "RefundAmount"))
            ...
            cmd.Connection = con
            cmd.Parameters.Add(New SqlParameter("Cancelled", System.Data.SqlDbType.NChar, 10, "RStatus"))
            cmd.Parameters("Cancelled").Value = RStatus.Text
